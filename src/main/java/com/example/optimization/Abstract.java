...
public class Abstract {
        ...
        Iimplementation implementation; // Bridge
        int n, precision = 10;
        void Welcome(String phase)
        {
            Button WelcomeButton = new Button("Welcome!");
            implementation = abstractFactory.get(phase);
            ...
            EventHandler<ActionEvent> event10 = new EventHandler<ActionEvent>(){
                ...
                public void handle(ActionEvent e) {
                    ...
                    if(method[0].equals("Gauss Elimination"))
                        solution[0] = implementation.firstMethod(All, precision);
                    else if(method[0].equals("Gauss Jordan"))
                        solution[0] = implementation.secondMethod(All, precision);
